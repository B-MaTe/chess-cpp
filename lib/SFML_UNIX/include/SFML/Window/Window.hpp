...
public:
    ...
    /// SFML_UNIX chose the closest match.
    ///
    ...
    /// SFML_UNIX will try to match the given limit as much as it can,
...
/// SFML_UNIX application. In order to inform the driver that an SFML_UNIX application
...
/// sf::Window window(sf::VideoMode(800, 600), "SFML_UNIX window");
///
