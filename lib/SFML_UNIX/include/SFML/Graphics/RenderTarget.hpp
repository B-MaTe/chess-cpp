...
public:
    ...
    ///
    /// This function can be used when you mix SFML_UNIX drawing
    /// and direct OpenGL rendering. Combined with popGLStates,
    /// it ensures that:
    /// \li SFML_UNIX's internal states are not messed up by your OpenGL code
    /// \li your OpenGL states are not modified by a call to a SFML_UNIX function
    ///
    ...
    /// states needed by SFML_UNIX are set, so that subsequent draw()
...
/// and regular SFML_UNIX drawing commands. When doing so, make sure that
