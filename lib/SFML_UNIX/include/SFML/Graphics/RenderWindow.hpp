...
public:
    ...
    ///
    /// Use this constructor if you want to create an SFML_UNIX
...
/// sf::RenderWindow window(sf::VideoMode(800, 600), "SFML_UNIX window");
///
...
/// and regular SFML_UNIX drawing commands.
///
/// \code
/// // Create the render window
/// sf::RenderWindow window(sf::VideoMode(800, 600), "SFML_UNIX OpenGL");
///
