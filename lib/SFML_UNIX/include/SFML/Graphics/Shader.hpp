...
public:
    ...
    /// very specific stuff to implement that SFML_UNIX doesn't support,
    ...
    /// used when drawing SFML_UNIX entities. It must be used only if you
    ...
    /// code or SFML_UNIX will result in a context switch.
    ///
...
///
/// Some SFML_UNIX-specific types can be converted:
...
/// in SFML_UNIX 1). This can be done in two different ways:
